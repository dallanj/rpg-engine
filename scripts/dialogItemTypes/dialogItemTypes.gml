function DanielJournal () : DialogItem () constructor {
	...
	dialog_script[0][1] = ["Daniel Lim","right","Maybe I shouldn't",[["inventory",1,false]],noone,noone,noone];
	// Script 2 - Unlocked after talking to sarah
	dialog_script[1][0] = ["Daniel Lim","right","Ok I read it",noone,noone,noone,noone];
	dialog_script[1][1] = ["Daniel Lim","right","I should tell Sarah",[["unlockDialog",obj_npc_sarah,1,false]],noone,noone,noone];
...
function DanielComputer () : DialogItem () constructor {
	...
	dialog_script[1][0] = ["Daniel Lim","right","Ok I turned it on",[["unlockDialog",obj_npc_bob,3,false]],noone,noone,noone];
	...
	dialog_script[2][1] = ["Daniel Lim","right","I should wait till after school",[["items",[{item: new Shell(),quantity: 15,rewarded: false},{item: new Ghost(),quantity: 1,rewarded: false}],object]],noone,noone,noone];
}
