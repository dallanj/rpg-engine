function DanielJournal () : DialogItem () constructor {
	...
	// Script 1
	dialog_script[0][0] = ["Daniel Lim","right","This is my journal, should I open it?",noone,noone,noone];
	dialog_script[0][1] = ["Daniel Lim","right","Maybe I shouldn't",noone,noone,noone];
	// Script 2 - Unlocked after talking to sarah
	dialog_script[1][0] = ["Daniel Lim","right","Ok I read it",noone,noone,noone];
	dialog_script[1][1] = ["Daniel Lim","right","I should tell Sarah",[[obj_npc_sarah,1]],noone,noone];
...
function DanielComputer () : DialogItem () constructor {
	...
	dialog_current = 0; // Active script unlocked
	// Script 1
	dialog_script[0][0] = ["Daniel Lim","right","This is my computer",noone,noone,noone];
	// Script 2 - Unlocked after starting quest from bob
	dialog_script[1][0] = ["Daniel Lim","right","Ok I turned it on",[[obj_npc_bob,3]],noone,noone];
}
