...
draw_sprite_ext(spr_dialog_luna, 0, vw - 720, view_yport[0], character_scale, character_scale, 0, -1, 1);
...
draw_sprite_ext(spr_dialog_name_tag, 0, vw  - (dialog_width / 2) + 80, vh + 95, 0.75, 0.75, 0, -1, 1);
